...
export default function ProfileScreen() {
  ...
  return <ScrollView style={s.screen} contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
    ...
    <Pressable onPress={()=>router.push('/notification-settings')} style={s.adminCard}><View><Text style={s.adminKicker}>ATHLETEN CENTER</Text><Text style={s.adminTitle}>Notification Settings</Text><Text style={s.meta}>Control training, competition, coach and account alerts.</Text></View><Text style={s.adminArrow}>›</Text></Pressable>
