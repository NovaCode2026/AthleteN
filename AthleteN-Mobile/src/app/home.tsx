...
export default function HomeScreen(){
 ...
 const load=useCallback(async()=>{
  ...
  const [t,w,m,e,n]=await Promise.all([
...
const s=StyleSheet.create({
 screen:{flex:1,backgroundColor:c.background},content:{paddingHorizontal:18,paddingTop:8,paddingBottom:48,gap:13},header:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},headerActions:{flexDirection:'row',alignItems:'center',gap:8},iconButton:{width:46,height:46,borderRadius:15,backgroundColor:c.surface,borderWidth:1,borderColor:c.borderStrong,alignItems:'center',justifyContent:'center',position:'relative'},badge:{position:'absolute',right:-2,top:-3,minWidth:17,height:17,paddingHorizontal:4,borderRadius:9,backgroundColor:c.danger,alignItems:'center',justifyContent:'center',borderWidth:2,borderColor:c.background},badgeText:{color:'#fff',fontSize:8,fontWeight:'900'},brandRow:{flexDirection:'row',alignItems:'center',gap:10},logo:{width:42,height:42,borderRadius:13},brand:{color:c.text,fontSize:16,fontWeight:'900',letterSpacing:3.3},brandSub:{color:c.muted,fontSize:7,fontWeight:'800',letterSpacing:1.1,marginTop:2},settings:{width:46,height:46,borderRadius:15,backgroundColor:c.surface,borderWidth:1,borderColor:c.borderStrong,alignItems:'center',justifyContent:'center'},settingsText:{color:c.text,fontSize:18},
 ...
 grid:{flexDirection:'row',flexWrap:'wrap',gap:10},streakCard:{flexDirection:'row',alignItems:'center',backgroundColor:c.surface,borderWidth:1,borderColor:c.borderStrong,borderRadius:20,padding:15,gap:12},streakIcon:{width:48,height:48,borderRadius:16,backgroundColor:c.accentSoft,alignItems:'center',justifyContent:'center'},streakFire:{color:c.accentBright,fontSize:22,fontWeight:'900'},streakCopy:{flex:1},streakKicker:{color:c.muted,fontSize:8,fontWeight:'900',letterSpacing:1.3},streakValue:{color:c.text,fontSize:23,fontWeight:'900',marginTop:2},metric:{width:'48%',minHeight:88,backgroundColor:c.surfaceRaised,borderWidth:1,borderColor:c.border,borderRadius:18,padding:14,justifyContent:'space-between'},metricLabel:{color:c.muted,fontSize:8,fontWeight:'900',letterSpacing:1},metricValue:{color:c.text,fontSize:23,fontWeight:'900'},
