...
const s = StyleSheet.create({
  ...
  roleProtected:{backgroundColor:c.surface,borderWidth:1,borderColor:c.border,borderRadius:14,padding:12,gap:5},roleProtectedTitle:{color:c.warning,fontSize:9,fontWeight:'900'},roleProtectedText:{color:c.muted,fontSize:10,lineHeight:16},rolePanel:{backgroundColor:c.surface,borderWidth:1,borderColor:c.borderStrong,borderRadius:14,padding:12,gap:8},rolePanelTitle:{color:c.accentBright,fontSize:9,fontWeight:'900'},rolePanelHint:{color:c.muted,fontSize:10,lineHeight:15},roleButtons:{flexDirection:'row',flexWrap:'wrap',gap:7},roleButton:{borderWidth:1,borderColor:c.border,borderRadius:10,paddingVertical:8,paddingHorizontal:10},roleButtonActive:{backgroundColor:c.accentSoft,borderColor:c.accent},roleButtonText:{color:c.muted,fontSize:8,fontWeight:'900'},roleButtonTextActive:{color:c.accentBright},meta:{color:c.muted,fontSize:12,lineHeight:18},denied:{flex:1,backgroundColor:c.background,alignItems:'center',justifyContent:'center',padding:30,gap:12},deniedTitle:{color:c.text,fontSize:24,fontWeight:'900'},
});
