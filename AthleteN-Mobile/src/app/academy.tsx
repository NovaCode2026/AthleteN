...
export default function Academy(){
 ...
 return <Screen bottomBar={bottomBar}>
  ...
  <View style={{marginTop:18,gap:10}}><PlanSection /><Pressable onPress={()=>router.push({pathname:'/navigation-settings',params:{mode:'academy'}})} style={{backgroundColor:c.surface,borderWidth:1,borderColor:c.borderStrong,borderRadius:18,padding:14,flexDirection:'row',alignItems:'center',gap:11}}><View style={{width:40,height:40,borderRadius:13,backgroundColor:c.accentSoft,alignItems:'center',justifyContent:'center'}}><Icon name="settings" size={19}/></View><View style={{flex:1}}><Text style={{color:c.accentBright,fontSize:8,fontWeight:'900',letterSpacing:1.2}}>PERSONALIZATION</Text><Text style={{color:c.text,fontSize:14,fontWeight:'900',marginTop:2}}>Customize bottom bar</Text><Text style={{color:c.muted,fontSize:10,marginTop:2}}>Choose and reorder Academy sections.</Text></View><Icon name="arrow" size={16} color={c.muted}/></Pressable>  </View>
